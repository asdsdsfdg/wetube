...
//따라서 간편하게 뷰 엔진의 일종인 pug를 사용해 템플릿 파일을 pug로 보내서 pug가 이를 html 형식으로 변환해 이곳으로 가져오도록 하자.

export const trending = (req, res) => res.render("home", { pageTitle: "Home" }); //view(템플릿)의 이름을 넣어주는데 여기선 home.pug니까 home을 넣어준다.
//템플릿을 렌더링하는 건 컨트롤러이므로 변수를 넣는것도 여기서 넣어야함. 렌더링 함수의 두번째인수에 마음껏 pug에서 설정한 변수의 값를 넣어줄 수 있음. {a: "xfd", b: "dfdf"}
